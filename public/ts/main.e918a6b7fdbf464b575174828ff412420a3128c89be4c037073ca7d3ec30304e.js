(()=>{var b=class e{galleryUID;items=[];constructor(t,n=1){if(window.PhotoSwipe==null||window.PhotoSwipeUI_Default==null){console.error("PhotoSwipe lib not loaded.");return}this.galleryUID=n,e.createGallery(t),this.loadItems(t),this.bindClick()}loadItems(t){this.items=[];let n=t.querySelectorAll("figure.gallery-image");for(let i of n){let a=i.querySelector("figcaption"),o=i.querySelector("img"),s={w:parseInt(o.getAttribute("width")),h:parseInt(o.getAttribute("height")),src:o.src,msrc:o.getAttribute("data-thumb")||o.src,el:i};a&&(s.title=a.innerHTML),this.items.push(s)}}static createGallery(t){let n=t.querySelectorAll("img.gallery-image");for(let o of Array.from(n)){let s=o.closest("p");if(!s||!t.contains(s)||(s.textContent.trim()==""&&s.classList.add("no-text"),!s.classList.contains("no-text")))continue;let p=o.parentElement.tagName=="A",u=o,r=document.createElement("figure");if(r.style.setProperty("flex-grow",o.getAttribute("data-flex-grow")||"1"),r.style.setProperty("flex-basis",o.getAttribute("data-flex-basis")||"0"),p&&(u=o.parentElement),u.parentElement.insertBefore(r,u),r.appendChild(u),o.hasAttribute("alt")){let d=document.createElement("figcaption");d.innerText=o.getAttribute("alt"),r.appendChild(d)}if(!p){r.className="gallery-image";let d=document.createElement("a");d.href=o.src,d.setAttribute("target","_blank"),o.parentNode.insertBefore(d,o),d.appendChild(o)}}let i=t.querySelectorAll("figure.gallery-image"),a=[];for(let o of i)a.length?o.previousElementSibling===a[a.length-1]?a.push(o):a.length&&(e.wrap(a),a=[o]):a=[o];a.length>0&&e.wrap(a)}static wrap(t){let n=document.createElement("div");n.className="gallery";let i=t[0].parentNode,a=t[0];i.insertBefore(n,a);for(let o of t)n.appendChild(o)}open(t){let n=document.querySelector(".pswp");new window.PhotoSwipe(n,window.PhotoSwipeUI_Default,this.items,{index:t,galleryUID:this.galleryUID,getThumbBoundsFn:a=>{let o=this.items[a].el.getElementsByTagName("img")[0],s=window.pageYOffset||document.documentElement.scrollTop,c=o.getBoundingClientRect();return{x:c.left,y:c.top+s,w:c.width}}}).init()}bindClick(){for(let[t,n]of this.items.entries())n.el.querySelector("a").addEventListener("click",a=>{a.preventDefault(),this.open(t)})}},S=b;var h={};if(localStorage.hasOwnProperty("StackColorsCache"))try{h=JSON.parse(localStorage.getItem("StackColorsCache"))}catch{h={}}async function L(e,t,n){if(!e)return await Vibrant.from(n).getPalette();if(!h.hasOwnProperty(e)||h[e].hash!==t){let i=await Vibrant.from(n).getPalette();h[e]={hash:t,Vibrant:{hex:i.Vibrant.hex,rgb:i.Vibrant.rgb,bodyTextColor:i.Vibrant.bodyTextColor},DarkMuted:{hex:i.DarkMuted.hex,rgb:i.DarkMuted.rgb,bodyTextColor:i.DarkMuted.bodyTextColor}},localStorage.setItem("StackColorsCache",JSON.stringify(h))}return h[e]}var V=(e,t=500)=>{e.classList.add("transiting"),e.style.transitionProperty="height, margin, padding",e.style.transitionDuration=t+"ms",e.style.height=e.offsetHeight+"px",e.offsetHeight,e.style.overflow="hidden",e.style.height="0",e.style.paddingTop="0",e.style.paddingBottom="0",e.style.marginTop="0",e.style.marginBottom="0",window.setTimeout(()=>{e.classList.remove("show"),e.style.removeProperty("height"),e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom"),e.style.removeProperty("overflow"),e.style.removeProperty("transition-duration"),e.style.removeProperty("transition-property"),e.classList.remove("transiting")},t)},U=(e,t=500)=>{e.classList.add("transiting"),e.style.removeProperty("display"),e.classList.add("show");let n=e.offsetHeight;e.style.overflow="hidden",e.style.height="0",e.style.paddingTop="0",e.style.paddingBottom="0",e.style.marginTop="0",e.style.marginBottom="0",e.offsetHeight,e.style.transitionProperty="height, margin, padding",e.style.transitionDuration=t+"ms",e.style.height=n+"px",e.style.removeProperty("padding-top"),e.style.removeProperty("padding-bottom"),e.style.removeProperty("margin-top"),e.style.removeProperty("margin-bottom"),window.setTimeout(()=>{e.style.removeProperty("height"),e.style.removeProperty("overflow"),e.style.removeProperty("transition-duration"),e.style.removeProperty("transition-property"),e.classList.remove("transiting")},t)},K=(e,t=500)=>window.getComputedStyle(e).display==="none"?U(e,t):V(e,t);function A(){let e=document.getElementById("toggle-menu");e&&e.addEventListener("click",()=>{document.getElementById("main-menu").classList.contains("transiting")||(document.body.classList.toggle("show-menu"),K(document.getElementById("main-menu"),300),e.classList.toggle("is-active"))})}function O(e,t,n){var i=document.createElement(e);for(let a in t)if(a&&t.hasOwnProperty(a)){let o=t[a];a=="dangerouslySetInnerHTML"?i.innerHTML=o.__html:o===!0?i.setAttribute(a,a):o!==!1&&o!=null&&i.setAttribute(a,o.toString())}for(let a=2;a<arguments.length;a++){let o=arguments[a];o&&i.appendChild(o.nodeType==null?document.createTextNode(o.toString()):o)}return i}var I=O;var E=class{localStorageKey="StackColorScheme";currentScheme;systemPreferScheme;constructor(t){this.bindMatchMedia(),this.currentScheme=this.getSavedScheme(),window.matchMedia("(prefers-color-scheme: dark)").matches===!0?this.systemPreferScheme="dark":this.systemPreferScheme="light",this.dispatchEvent(document.documentElement.dataset.scheme),t&&this.bindClick(t),document.body.style.transition==""&&document.body.style.setProperty("transition","background-color .3s ease")}saveScheme(){localStorage.setItem(this.localStorageKey,this.currentScheme)}bindClick(t){t.addEventListener("click",n=>{this.isDark()?this.currentScheme="light":this.currentScheme="dark",this.setBodyClass(),this.currentScheme==this.systemPreferScheme&&(this.currentScheme="auto"),this.saveScheme()})}isDark(){return this.currentScheme=="dark"||this.currentScheme=="auto"&&this.systemPreferScheme=="dark"}dispatchEvent(t){let n=new CustomEvent("onColorSchemeChange",{detail:t});window.dispatchEvent(n)}setBodyClass(){this.isDark()?document.documentElement.dataset.scheme="dark":document.documentElement.dataset.scheme="light",this.dispatchEvent(document.documentElement.dataset.scheme)}getSavedScheme(){let t=localStorage.getItem(this.localStorageKey);return t=="light"||t=="dark"||t=="auto"?t:"auto"}bindMatchMedia(){window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",t=>{t.matches?this.systemPreferScheme="dark":this.systemPreferScheme="light",this.setBodyClass()})}},T=E;function f(e){let t;return()=>{t&&window.cancelAnimationFrame(t),t=window.requestAnimationFrame(()=>e())}}var $=".article-content h1[id], .article-content h2[id], .article-content h3[id], .article-content h4[id], .article-content h5[id], .article-content h6[id]",x="#TableOfContents",k="#TableOfContents li",M="active-class";function R(e,t){let n=e.querySelector("a").offsetHeight,i=e.offsetTop-t.offsetHeight/2+n/2-t.offsetTop;i<0&&(i=0),t.scrollTo({top:i,behavior:"smooth"})}function F(e){let t={};return e.forEach(n=>{let a=n.querySelector("a").getAttribute("href");a.startsWith("#")&&(t[a.slice(1)]=n)}),t}function B(e){let t=[];return e.forEach(n=>{t.push({id:n.id,offset:n.offsetTop})}),t.sort((n,i)=>n.offset-i.offset),t}function C(){let e=document.querySelectorAll($);if(!e){console.warn("No header matched query",e);return}let t=document.querySelector(x);if(!t){console.warn("No toc matched query",x);return}let n=document.querySelectorAll(k);if(!n){console.warn("No navigation matched query",k);return}let i=B(e),a=!1;t.addEventListener("mouseenter",f(()=>a=!0)),t.addEventListener("mouseleave",f(()=>a=!1));let o,s=F(n);function c(){let u=document.documentElement.scrollTop||document.body.scrollTop,r;i.forEach(g=>{u>=g.offset-20&&(r=document.getElementById(g.id))});let d;r&&(d=s[r.id]),r&&!d?console.debug("No link found for section",r):d!==o&&(o&&o.classList.remove(M),d&&(d.classList.add(M),a||R(d,t)),o=d)}window.addEventListener("scroll",f(c));function p(){i=B(e),c()}window.addEventListener("resize",f(p))}var _="a[href]";function H(){document.querySelectorAll(_).forEach(e=>{e.getAttribute("href").startsWith("#")&&e.addEventListener("click",n=>{n.preventDefault();let i=decodeURI(e.getAttribute("href").substring(1)),a=document.getElementById(i),o=a.getBoundingClientRect().top-document.documentElement.getBoundingClientRect().top;window.history.pushState({},"",e.getAttribute("href")),scrollTo({top:o,behavior:"smooth"})})})}var w=class{localStorageKey="StackAdminAuth";attemptsKey="StackAuthAttempts";timestampKey="StackAuthTimestamp";currentStatus;config;constructor(t){this.config={adminPassword:"admit",sessionTimeout:24*60*60*1e3,maxLoginAttempts:5,...t},this.currentStatus=this.getSavedAuthStatus(),this.cleanupExpiredSession(),this.dispatchAuthEvent(this.currentStatus)}authenticate(t){return this.isBlocked()?(this.dispatchAuthEvent("blocked"),!1):t===this.config.adminPassword?(this.currentStatus="authenticated",this.saveAuthStatus(),this.clearLoginAttempts(),this.dispatchAuthEvent("authenticated"),!0):(this.incrementLoginAttempts(),this.dispatchAuthEvent("failed"),!1)}logout(){this.currentStatus="guest",this.clearAuthData(),this.dispatchAuthEvent("guest")}isAuthenticated(){return this.isSessionExpired()?(this.logout(),!1):this.currentStatus==="authenticated"}isAdmin(){return this.isAuthenticated()}getStatus(){return this.currentStatus}isBlocked(){return this.getLoginAttempts()>=this.config.maxLoginAttempts}getRemainingAttempts(){let t=this.getLoginAttempts();return Math.max(0,this.config.maxLoginAttempts-t)}resetLoginAttempts(){this.clearLoginAttempts()}saveAuthStatus(){localStorage.setItem(this.localStorageKey,this.currentStatus),localStorage.setItem(this.timestampKey,Date.now().toString())}getSavedAuthStatus(){return localStorage.getItem(this.localStorageKey)==="authenticated"?"authenticated":"guest"}isSessionExpired(){let t=localStorage.getItem(this.timestampKey);if(!t)return!0;let n=parseInt(t);return Date.now()-n>this.config.sessionTimeout}cleanupExpiredSession(){this.isSessionExpired()&&(this.clearAuthData(),this.currentStatus="guest")}clearAuthData(){localStorage.removeItem(this.localStorageKey),localStorage.removeItem(this.timestampKey)}getLoginAttempts(){let t=localStorage.getItem(this.attemptsKey);return t?parseInt(t):0}incrementLoginAttempts(){let t=this.getLoginAttempts()+1;localStorage.setItem(this.attemptsKey,t.toString())}clearLoginAttempts(){localStorage.removeItem(this.attemptsKey)}dispatchAuthEvent(t){let n=new CustomEvent("onAuthStatusChange",{detail:{status:t,isAuthenticated:this.isAuthenticated(),isAdmin:this.isAdmin(),remainingAttempts:this.getRemainingAttempts()}});window.dispatchEvent(n)}},m={toggleAdminElements:e=>{let t=document.querySelectorAll("[data-admin-only]"),n=document.querySelectorAll("[data-guest-only]");t.forEach(i=>{i.style.display=e?"":"none"}),n.forEach(i=>{i.style.display=e?"none":""})},updateBodyClass:e=>{e?(document.body.classList.add("admin-mode"),document.body.classList.remove("guest-mode")):(document.body.classList.add("guest-mode"),document.body.classList.remove("admin-mode"))},createLoginModal:()=>`
        ...
        `},P=w;var v,l={init:()=>{v=new P,window.addEventListener("onAuthStatusChange",o=>{let{status:s,isAuthenticated:c,isAdmin:p,remainingAttempts:u}=o.detail;switch(m.toggleAdminElements(p),m.updateBodyClass(p),s){case"authenticated":m.hideLoginModal(),console.log("Admin authenticated successfully");break;case"failed":m.showLoginError("\u5BC6\u7801\u9519\u8BEF"),u>0&&m.showAttemptsInfo(u);break;case"blocked":m.showLoginError("\u767B\u5F55\u5C1D\u8BD5\u6B21\u6570\u8FC7\u591A\uFF0C\u8BF7\u7A0D\u540E\u518D\u8BD5");break;case"guest":console.log("User logged out or session expired");break}}),setTimeout(()=>{let o=m.createLoginModal(),s=m.createAdminPanel();document.body.insertAdjacentHTML("beforeend",o),document.body.insertAdjacentHTML("beforeend",s),l.bindAuthEvents(),l.bindAdminPanelEvents();let c=v.isAuthenticated();m.toggleAdminElements(c),m.updateBodyClass(c),l.loadAdminSettings()},100),A();let e=document.querySelector(".article-content");e&&(new S(e),H(),C());let t=document.querySelector(".article-list--tile");t&&new IntersectionObserver(async(s,c)=>{s.forEach(p=>{if(!p.isIntersecting)return;c.unobserve(p.target),p.target.querySelectorAll("article.has-image").forEach(async r=>{let d=r.querySelector("img"),g=d.src,D=d.getAttribute("data-key"),q=d.getAttribute("data-hash"),N=r.querySelector(".article-details"),y=await L(D,q,g);N.style.background=`
                        linear-gradient(0deg, 
                            rgba(${y.DarkMuted.rgb[0]}, ${y.DarkMuted.rgb[1]}, ${y.DarkMuted.rgb[2]}, 0.5) 0%, 
                            rgba(${y.Vibrant.rgb[0]}, ${y.Vibrant.rgb[1]}, ${y.Vibrant.rgb[2]}, 0.75) 100%)`})})}).observe(t);let n=document.querySelectorAll(".article-content div.highlight"),i="Copy",a="Copied!";n.forEach(o=>{let s=document.createElement("button");s.innerHTML=i,s.classList.add("copyCodeButton"),o.appendChild(s);let c=o.querySelector("code[data-lang]");c&&s.addEventListener("click",()=>{navigator.clipboard.writeText(c.textContent).then(()=>{s.textContent=a,setTimeout(()=>{s.textContent=i},1e3)}).catch(p=>{alert(p),console.log("Something went wrong",p)})})}),new T(document.getElementById("dark-mode-toggle"))},bindAuthEvents:()=>{let e=document.getElementById("admin-login-form");e&&e.addEventListener("submit",o=>{o.preventDefault();let s=document.getElementById("admin-password");s&&v.authenticate(s.value)});let t=document.getElementById("admin-modal-close"),n=document.getElementById("admin-cancel-btn");t&&t.addEventListener("click",()=>{m.hideLoginModal()}),n&&n.addEventListener("click",()=>{m.hideLoginModal()});let i=document.getElementById("admin-login-modal");i&&i.addEventListener("click",o=>{o.target===i&&m.hideLoginModal()}),document.addEventListener("keydown",o=>{o.key==="Escape"&&m.hideLoginModal()});let a=document.getElementById("admin-panel-toggle");a&&a.addEventListener("click",o=>{o.preventDefault(),l.showAdminPanel()})},bindAdminPanelEvents:()=>{let e=document.getElementById("admin-panel-close"),t=document.getElementById("admin-panel-cancel");e&&e.addEventListener("click",()=>{l.hideAdminPanel()}),t&&t.addEventListener("click",()=>{l.hideAdminPanel()});let n=document.getElementById("admin-panel-modal");n&&n.addEventListener("click",u=>{u.target===n&&l.hideAdminPanel()}),document.querySelectorAll(".admin-tab-btn").forEach(u=>{u.addEventListener("click",r=>{let g=r.target.getAttribute("data-tab");g&&l.switchAdminTab(g)})});let a=document.getElementById("admin-avatar-upload");a&&a.addEventListener("change",u=>{let r=u.target;r.files&&r.files[0]&&l.handleAvatarUpload(r.files[0])});let o=document.getElementById("admin-avatar-reset");o&&o.addEventListener("click",()=>{l.resetAvatar()});let s=document.getElementById("admin-save-settings");s&&s.addEventListener("click",()=>{l.saveAdminSettings()});let c=document.getElementById("admin-theme-color");c&&c.addEventListener("change",u=>{let r=u.target;l.updateThemeColor(r.value)});let p=document.getElementById("admin-change-password");p&&p.addEventListener("click",()=>{l.changeAdminPassword()})},getAuth:()=>v,showLogin:()=>{m.showLoginModal()},logout:()=>{v&&v.logout()},showAdminPanel:()=>{let e=document.getElementById("admin-panel-modal");e&&(e.style.display="flex",l.loadAdminSettings())},hideAdminPanel:()=>{let e=document.getElementById("admin-panel-modal");e&&(e.style.display="none")},switchAdminTab:e=>{document.querySelectorAll(".admin-tab-btn").forEach(i=>{i.classList.remove("active")}),document.querySelectorAll(".admin-tab-panel").forEach(i=>{i.classList.remove("active")});let t=document.querySelector(`[data-tab="${e}"]`),n=document.getElementById(`admin-tab-${e}`);t&&t.classList.add("active"),n&&n.classList.add("active")},handleAvatarUpload:e=>{if(e.type.startsWith("image/")){let t=new FileReader;t.onload=n=>{let i=n.target?.result,a=document.getElementById("admin-avatar-img");a&&(a.src=i,localStorage.setItem("adminAvatar",i),l.updateSiteAvatar(i))},t.readAsDataURL(e)}},resetAvatar:()=>{let e="/img/avatar_hu_f509edb42ecc0ebd.png",t=document.getElementById("admin-avatar-img");t&&(t.src=e,localStorage.removeItem("adminAvatar"),l.updateSiteAvatar(e))},updateSiteAvatar:e=>{let t=document.querySelector(".site-avatar img");t&&(t.src=e)},loadAdminSettings:()=>{let e=localStorage.getItem("adminAvatar");if(e){let a=document.getElementById("admin-avatar-img");a&&(a.src=e),l.updateSiteAvatar(e)}let t=localStorage.getItem("adminSiteTitle");if(t){let a=document.getElementById("admin-site-title");a&&(a.value=t);let o=document.querySelector(".site-name a");o&&(o.textContent=t)}let n=localStorage.getItem("adminSiteDescription");if(n){let a=document.getElementById("admin-site-description");a&&(a.value=n);let o=document.querySelector(".site-description");o&&(o.textContent=n)}let i=localStorage.getItem("adminThemeColor");if(i){let a=document.getElementById("admin-theme-color");a&&(a.value=i),l.updateThemeColor(i)}},saveAdminSettings:()=>{let e=document.getElementById("admin-site-title");if(e){localStorage.setItem("adminSiteTitle",e.value);let i=document.querySelector(".site-name a");i&&(i.textContent=e.value)}let t=document.getElementById("admin-site-description");if(t){localStorage.setItem("adminSiteDescription",t.value);let i=document.querySelector(".site-description");i&&(i.textContent=t.value)}let n=document.getElementById("admin-theme-color");n&&localStorage.setItem("adminThemeColor",n.value),l.showSuccessMessage("\u8BBE\u7F6E\u5DF2\u4FDD\u5B58\uFF01"),l.hideAdminPanel()},updateThemeColor:e=>{document.documentElement.style.setProperty("--accent-color",e);let t=document.querySelector(".admin-color-preview");t&&(t.style.backgroundColor=e)},changeAdminPassword:()=>{let e=document.getElementById("admin-new-password");e&&e.value?(l.showSuccessMessage("\u5BC6\u7801\u66F4\u6539\u529F\u80FD\u9700\u8981\u540E\u7AEF\u652F\u6301\uFF0C\u5F53\u524D\u4E3A\u6F14\u793A\u6A21\u5F0F"),e.value=""):l.showErrorMessage("\u8BF7\u8F93\u5165\u65B0\u5BC6\u7801")},showSuccessMessage:e=>{l.showNotification(e,"success")},showErrorMessage:e=>{l.showNotification(e,"error")},showNotification:(e,t="success")=>{let n=document.createElement("div");n.className=`admin-notification admin-notification-${t}`,n.innerHTML=`
