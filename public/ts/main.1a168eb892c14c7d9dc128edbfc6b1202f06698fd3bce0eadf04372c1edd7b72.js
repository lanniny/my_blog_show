(() => {
  ...
  // ns-hugo-imp:C:\Users\16643\Desktop\blog\hugo\blog\assets\ts\article-detail-enhance.ts
  var ArticleDetailEnhance = {
    /**
     * 初始化文章详情页增强功能
     */
    init() {
      console.log("\u{1F4D6} Initializing article detail enhancement...");
     ...
     */
    isArticlePage() {
      return document.querySelector(".article-content") !== null || document.querySelector(".post-content") !== null || document.querySelector('[class*="content"]') !== null;
    },
    /**
     * 设置所有功能
     */
    ...
    setupTableOfContents() {
      const contentArea = document.querySelector('.article-content, .post-content, [class*="content"]');
      const sidebar = document.querySelector(".article-sidebar, .sidebar");
     ...
     * 设置目录滚动监听
     */
    setupTocScrollSpy(tocContainer) {
    ...
    setupReadingProgress() {
      const sidebar = document.querySelector(".article-sidebar, .sidebar");
      const contentArea = document.querySelector(".article-content, .post-content");
      ...
      const progressFill = progressContainer.querySelector(".reading-progress-fill");
      let ticking = false;
      const updateProgress = () => {
  ...
  window.ArticleDetailEnhance = ArticleDetailEnhance;
